...
Implementar la clase LinkedList, definiendo los siguientes métodos:
  ...
  coincida con lo buscado; en el segundo, buscamos un nodo cuyo valor, al ser pasado como parámetro del callback, retorne true. 
  EJEMPLO 
...
if (typeof value !== 'function') {
  if (current === value) return current;
    ...
    return current.value === value ? current.value : false;
  }
}
...
La clase debe tener los siguientes métodos:
  ...
  suma el código numérico de cada caracter del input (investigar el método charCodeAt de los strings)
   y calcula el módulo de ese número total por la cantidad de buckets; de esta manera determina la 
